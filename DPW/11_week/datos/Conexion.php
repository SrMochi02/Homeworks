...
class Conexion {
    ...
    private function create_connection()
    {
        try{
            ...
            die ('<h3 style="color: tomato; font-family:Arial;">No se puede establecer la conexion con la base de datos: '. $e->getMessage().'</h3>');
        }
    ...
    /*Obtener un unico registro mediante la consulta SELECT*/
